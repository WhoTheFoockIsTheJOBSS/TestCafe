...
test('Loading main page', async t=> {
    ...
    .expect(Selector('a.submitButton')).ok('el boton existe en la pagina');
});

test('addin an device', async t=> {
    ...
    await t.expect('http://localhost:3001/devices/').eql('http://localhost:3001/devices/');
});